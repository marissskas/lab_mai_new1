...
class DatabaseApp:
    ...
    def __init__(self):
        ...
        self.running = True
        # Создаём таблицу студентов в выбранной БД
    ...
    def _init_student_table(self):
        """Создаёт таблицу студентов в выбранной базе данных."""
        table_name = "студенты"
        ...
        try:
            ...
            if table_name not in existing_tables:
                ...
                print(f"Таблица '{table_name}' создана (поля: id, имя, фамилия, возраст, пол)")
            else:
                records_count = len(self.db.select(table_name))
                print(f"Таблица '{table_name}' уже существует, загружено {records_count} записей")
    ...
    def select_all(self):
        ...
        try:
            ...
            if "id" in first_record and "имя" in first_record and "фамилия" in first_record:
