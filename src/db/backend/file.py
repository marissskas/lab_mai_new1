...
class FileDatabase(Database):
    ...
    def __init__(self, directory: str = "data") -> None:
        ...
        try:
            ...
            raise InvalidStorageDataError(
                f"Не удалось создать директорию для данных '{directory}': {error}"
            ) from error
    ...
    # ============================================================
    # Реализация абстрактных методов Database
    # ============================================================
    ...
    # ============================================================
    # Дополнительные методы для совместимости с TUI
    # ============================================================
    ...
    def get_table_names(self) -> list[str]:
        ...
        try:
            ...
            raise InvalidStorageDataError(
                f"Ошибка при чтении директории с таблицами: {error}"
            ) from error
    ...
    def get_table_info(self, table_name: str) -> Optional[dict]:
        ...
        try:
            ...
            raise InvalidStorageDataError(
                f"Ошибка доступа к таблице '{table_name}': {error}"
            ) from error
