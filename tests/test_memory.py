...
class TestMemoryDatabase(unittest.TestCase):
    ...
    def test_delete_by_age(self):
        """Тест удаления студентов по возрасту."""
        self.db.create_table("студенты", ("id", "имя", "возраст"))
        self.db.insert("студенты", {"id": "1", "имя": "Анна Иванова", "возраст": "16"})
        self.db.insert("студенты", {"id": "2", "имя": "Борис Смирнов", "возраст": "17"})
        self.db.insert("студенты", {"id": "3", "имя": "Вера Козлова", "возраст": "16"})

        count = self.db.delete("студенты", возраст="16")
        self.assertEqual(count, 2)

        records = self.db.select("студенты")
        self.assertEqual(len(records), 1)
        self.assertEqual(records[0]["имя"], "Борис Смирнов")

    def test_sort_records_ascending_by_id(self):
    ...
    def test_sort_records_descending_by_id(self):
